<!-- 地图组件，geoIndex的配置 -->
<template>
  <div ref="geoIndex" class="geo-index"></div>
</template>
...
export default {
  ...
  methods: {
    ...
    geoIndexDemo() {
      let dom = this.$refs.geoIndex;
      let geoIndexEcharts = this.$echarts.init(dom);

      geoIndexEcharts.showLoading();

      // let w = geoIndexEcharts.getWidth()
      // let h = geoIndexEcharts.getHeight()
      let d = geoIndexEcharts.getDom();
      // console.log(123,w);
      // console.log(456,h);
      console.log(567, d);
      ...
      geoIndexEcharts.setOption(option);

      geoIndexEcharts.hideLoading();

      // getOption 方法要在setOption 后调用才有效
      let o = geoIndexEcharts.getOption();
      console.log(678, o);
    },
  },
};
